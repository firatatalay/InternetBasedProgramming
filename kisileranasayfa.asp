...
<body bgcolor="#EAEAEA" >
	...
	<div class=main style="height:1200;">
	<br>
	<br>
	<center>	
	<img  src="resim/robot.jpg"> </center>
	...
	<center>
		...
		<br>
			...
			<table>
			<th> Mr. Robot'a Yorum</th>
				
				<tr>
					
					<td>
					<form action="robotyorum.asp" method="post"> <textarea name="metin" rows="15" cols="100">Yorum Alanı</textarea>
					</td>
				</tr>
			</table>
			<br>
